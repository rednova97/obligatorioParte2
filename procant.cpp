...
void juego(int opcion, int &resultado, int apuesta, int &saldo, int &cantidadAciertos, bool &acertar, bool &orgullo);   //el juego en si mismo
...
void juego(int opcion, int &resultado, int apuesta, int &saldo, int &cantidadAciertos, bool &acertar, bool &orgullo){
    ...
    while (saldo > 1000)
    {
        printf("Por favor ingrese un saldo menor o igual a 1000.\n");
        scanf("%d", &saldo);
    }
